...
<div class="container-xl mb-4">
   <div class="row g-2 align-items-center">
      <div class="col">
         <h2 class="page-title">Daftar Hari dan Takjil Settings</h2>
      </div>
   </div>
</div>
...
<div class="card">
   ...
   <div id="cards-container">
      @include('ramadhan.daySettings.partials.table', ['daySettings' => $daySettings])
   </div>
</div>
...
<script>
   document.addEventListener('DOMContentLoaded', function() {
      ...
      function fetchResults(q = '') {
         const url = new URL("{{ route('day-settings.index') }}", location.origin);
