...
<div class="page-header">
   <div class="container-xl">
      <h2 class="page-title">
         Edit Day Settings Ramadhan {{ $ramadhanSetting->start_date->year }}
      </h2>
   </div>
</div>
...
<script>
   document.addEventListener("DOMContentLoaded", function() {
      ...
      // Event realtime untuk semua input
      [...quotaInputs, ...makananInputs, ...minumanInputs].forEach(input => {
         input.addEventListener("input", updateTotals);
      });

      // ============================
      // Autofill Pembagian 7 Hari Awal Lebih Besar
      // ============================
      btnAutofill?.addEventListener("click", function() {
         ...
         // Tentukan pembagian
         const bigQuota = Math.ceil(totalSetoran * 0.07); // 7% tiap hari awal
         ...
         rows.forEach((tr, index) => {
            ...
            if (index < 7) {
               quotaField.value = bigQuota;
            } else {
               quotaField.value = normalQuota;
            }
         });
      ...
      // ============================
      // RESET KE DATA AWAL (CREATE / EDIT)
      // ============================
