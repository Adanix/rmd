...
<div class="container-xl mb-4">
   <div class="row g-2 align-items-center">
      <div class="col">
         <h2 class="page-title">Generate Day Settings Ramadhan {{ $ramadhanSetting->start_date->year }}</h2>
      </div>
   </div>
</div>
         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
               ...
               <div>
                  ...
                  <div>Sisa Kuota: <strong id="sisaQuota">0</strong> <span id="statusQuota" class="badge bg-secondary-lt ms-1">-</span></div>
...
<script>
   document.addEventListener('DOMContentLoaded', function() {
      ...
      // ⭐ INI AMAN! langsung ambil dari PHP, tanpa Number()
      const totalSetoran = {{$totalSetoran}};

      // ⭐ default days 100% valid
      ...
      function refreshTotals() {
         ...
         if (sisa === 0) {
            elStatusQuota.classList.add('bg-success-lt');
            elStatusQuota.textContent = 'Sudah Pas';
         } else if (sisa > 0) {
            elStatusQuota.classList.add('bg-warning-lt');
            elStatusQuota.textContent = 'Belum Terpenuhi';
         } else {
            elStatusQuota.classList.add('bg-danger-lt');
      ...
      function resetToDefault() {
         ...
         rows.forEach((row, i) => {
            ...
            row.querySelector('.quota-input').value = d.quota;
            row.querySelector('.makanan-input').value = d.total_makanan_planned;
            row.querySelector('.minuman-input').value = d.total_minuman_planned;
            row.querySelector('.notes-input').value = d.notes ?? '';
         });
