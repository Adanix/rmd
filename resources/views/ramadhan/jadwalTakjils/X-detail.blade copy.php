...
<body>
   ...
   <div class="container">
      ...
      <div class="card kartu-takjil" data-index="{{ $index }}" id="kartu-{{ $index }}">
         <!-- Card Header -->
   ...
   <div class="fab-container">
      ...
      <!-- Back Button -->
      <a href="{{ url()->previous() }}" class="fab-btn fab-btn-secondary">
                  ...
                  <div class="list-group list-group-flush">
                     ...
                     <div class="list-group-item px-0">
                        <div class="row align-items-center">
                           <div class="col-auto">
                              <span class="badge bg-primary rounded-circle" style="width: 36px; height: 36px; display: flex; align-items: center; justify-content: center;">
                                 {{ $index + 1 }}
                              </span>
                           </div>
                           <div class="col">
                           ...
                           <div class="col-auto">
                              <button onclick="downloadSingleCard({{$index}})" class="btn btn-sm btn-primary">
   ...
   <script>
     ...
     `;
      ...
      function downloadSingleCard(cardIndex) {
