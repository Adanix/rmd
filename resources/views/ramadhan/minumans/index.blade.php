   ...
   <div class="container-xl">
      ...
      <div class="card">
         <div class="card-header d-flex justify-content-between">
            ...
            <a href="{{ route('minumans.create') }}" class="btn btn-primary">
               + Tambah Minuman
            </a>
         </div>
         ...
         <div id="cards-container">
            @include('ramadhan.minumans.partials.table', ['minumans' => $minumans])
         </div>
...
<script>
   document.addEventListener('DOMContentLoaded', function() {
      ...
      function fetchResults(q = '') {
         const url = new URL("{{ route('minumans.index') }}", location.origin);
